        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center list_back_head">
				 ...
				 <div class="col-lg-12 text-center list_back_head">
                     <button href="#add_guest" type="button" class="add_guest btn btn-xl fancybox">Add Guest</button>
            ...
            <div class="row text-center ">
				  ...
				  <table class="guestList">
					...
					<?php foreach($guest_details as $guest_info) {?>
					 <tr  >
						...
						<td> <?php echo $guest_info['attend']==1?'Yes':'Nil' ;?>  </td>
						<td class="drop_box">  
						 
						<div class="not-fixed">
						 
						<ul  class=" sortable1" data-email="<?php echo $guest_info['email'] ;?>" data-id="<?php echo $list_details['id'];?>">	
				...
				<div class="gift_conainer">
					<div class="ggt_grp"> <i class="fa fa-usd"></i> <i class="fa fa-envelope"></i> <i class="fa fa-money"></i> <?php echo $list_details['money_pot_value'];?>  </div>
					<ul id="sortable2" class="dragitem">
						<?php if(!empty($gift_details)) {?>
							<?php foreach($gift_details as $gift_info) {?>				
						 		<li gift-type='<?php echo $gift_info['gift_type'];?>' data-id="<?php echo $gift_info['id'];?>" class="ui-state-highlight"><i class="fa <?php echo $gift_info['icon'];?>"></i> <?php echo $gift_info['gname'];?></li>						 
							<?php } ?>	
						<?php } ?>	
